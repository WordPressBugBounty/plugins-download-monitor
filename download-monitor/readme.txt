...
== Changelog ==
= 5.2.8 - 02.09.2026 =
Fixed: PayPal checkout could fail without showing an error message.
Fixed: Shop currency list limited to currencies supported by PayPal.
...
Added: The download_data shortcode now supports custom meta fields.
